 ...
 *           (C) 2014         Vineeth Raj (alias thewisenerd) <contact.twn@opmbx.org>
 *
...
#ifdef CONFIG_GENERIC_BLN_ENABLED
static bool bln_enabled = true;                  /* Activation status of BLN feature */
#else
...
#ifdef CONFIG_GENERIC_BLN_BLINK_ENABLED
static bool bln_in_kernel_blink = true;          /* Activation status of in-kernel blinking lights */
#else
